...
<body>
    ...
    <header class="Iniciopagina">

        <h1> Seja Bem Vindo! </h1>

    </header>
    
    <div class="Divtelainiciologado" >
        
        <button class="labelmedicamentos"> MEDICAMENTOS </button>

        <button class="labelprodutos"> PRODUTOS </button>

        <button class="labelgerente"> GERENTE </button>

        <button class="labelfarmaceutico"> <a href="cadastrofarmaceutico.php"  style="text-decoration:none" > FARMACEUTICO </button>
